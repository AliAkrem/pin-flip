...
class PinFlipOptions {
  const PinFlipOptions({
  ...
  static PinFlipOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope!.modelBindingState.currentModel;
  }

  static void update(BuildContext context, PinFlipOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
/// Applies text [PinFlipOptions] to a widget
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = PinFlipOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ...
  final PinFlipOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late PinFlipOptions currentModel;
  ...
  void handleTimeDilation(PinFlipOptions newModel) {
  ...
  void updateModel(PinFlipOptions newModel) {
